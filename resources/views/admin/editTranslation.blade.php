    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.updateTranslation') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="language_name"
                            placeholder="Enter new language name" required="required" value="{{ $language_name }}">
                    </div>
                </div>
                <hr>
                <!-- DESKTOP -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="summernote-editor" name="desktopSubHeading" placeholder="Sub Heading Text"
                            rows="6">{{ $data->desktopSubHeading }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="desktopAchievementThreeSub"
                            value="{{ $data->desktopAchievementThreeSub }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="summernote-editor"
                            name="desktopFooterAddress">{{ $data->desktopFooterAddress }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="desktopSocialFacebookLink"
                            value="{{ $data->desktopSocialFacebookLink }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="desktopSocialGoogleLink"
                            value="{{ $data->desktopSocialGoogleLink }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="desktopSocialYoutubeLink"
                            value="{{ $data->desktopSocialYoutubeLink }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="desktopSocialInstagramLink"
                            value="{{ $data->desktopSocialInstagramLink }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="changeLanguageText"
                            value="@if (!empty($data->changeLanguageText)) {{ $data->changeLanguageText }}@else{{ config('setting.changeLanguageText') }}@endif"
                            placeholder="Change Language Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="desktopTryItOnPhoneTitle"
                            value="@if (!empty($data->desktopTryItOnPhoneTitle)) {{ $data->desktopTryItOnPhoneTitle }}@else{{ config('setting.desktopTryItOnPhoneTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="desktopTryItOnPhoneSubTitle"
                            value="@if (!empty($data->desktopTryItOnPhoneSubTitle)) {{ $data->desktopTryItOnPhoneSubTitle }}@else{{ config('setting.desktopTryItOnPhoneSubTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="minimumLengthValidationMessage"
                            value="{{ $data->minimumLengthValidationMessage }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="emailPhoneAlreadyRegistered"
                            value="{{ $data->emailPhoneAlreadyRegistered }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="forgotPasswordLinkText"
                            value="@if (!empty($data->forgotPasswordLinkText)) {{ $data->forgotPasswordLinkText }}@else{{ config('setting.forgotPasswordLinkText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="resetPasswordPageTitle"
                            value="@if (!empty($data->resetPasswordPageTitle)) {{ $data->resetPasswordPageTitle }}@else{{ config('setting.resetPasswordPageTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="resetPasswordPageSubTitle"
                            value="@if (!empty($data->resetPasswordPageSubTitle)) {{ $data->resetPasswordPageSubTitle }}@else{{ config('setting.resetPasswordPageSubTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="userNotFoundErrorMessage"
                            value="@if (!empty($data->userNotFoundErrorMessage)) {{ $data->userNotFoundErrorMessage }}@else{{ config('setting.userNotFoundErrorMessage') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="invalidOtpErrorMessage"
                            value="@if (!empty($data->invalidOtpErrorMessage)) {{ $data->invalidOtpErrorMessage }}@else{{ config('setting.invalidOtpErrorMessage') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="sendOtpOnEmailButtonText"
                            value="@if (!empty($data->sendOtpOnEmailButtonText)) {{ $data->sendOtpOnEmailButtonText }}@else{{ config('setting.sendOtpOnEmailButtonText') }}@endif"
                            placeholder="Send OTP Button Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="alreadyHaveResetOtpButtonText"
                            value="@if (!empty($data->alreadyHaveResetOtpButtonText)) {{ $data->alreadyHaveResetOtpButtonText }}@else{{ config('setting.alreadyHaveResetOtpButtonText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="dontHaveResetOtpButtonText"
                            value="@if (!empty($data->dontHaveResetOtpButtonText)) {{ $data->dontHaveResetOtpButtonText }}@else{{ config('setting.dontHaveResetOtpButtonText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="enterResetOtpMessageText"
                            value="@if (!empty($data->enterResetOtpMessageText)) {{ $data->enterResetOtpMessageText }}@else{{ config('setting.enterResetOtpMessageText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="verifyResetOtpButtonText"
                            value="@if (!empty($data->verifyResetOtpButtonText)) {{ $data->verifyResetOtpButtonText }}@else{{ config('setting.verifyResetOtpButtonText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="enterNewPasswordText"
                            value="@if (!empty($data->enterNewPasswordText)) {{ $data->enterNewPasswordText }}@else{{ config('setting.enterNewPasswordText') }}@endif"
                            placeholder="Enter New Password Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="newPasswordLabelText"
                            value="@if (!empty($data->newPasswordLabelText)) {{ $data->newPasswordLabelText }}@else{{ config('setting.newPasswordLabelText') }}@endif"
                            placeholder="New Password Label Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="setNewPasswordButtonText"
                            value="@if (!empty($data->setNewPasswordButtonText)) {{ $data->setNewPasswordButtonText }}@else{{ config('setting.setNewPasswordButtonText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="summernote-editor" name="registrationPolicyMessage"
                            ...
                            rows="6">@if (!empty($data->registrationPolicyMessage)) {{ $data->registrationPolicyMessage }}@else{{ config('setting.registrationPolicyMessage') }}@endif</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="summernote-editor" name="customHomeMessage"
                            ...
                            rows="6">@if (!empty($data->customHomeMessage)) {{ $data->customHomeMessage }}@else{{ config('setting.customHomeMessage') }}@endif</textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="footerAlerts"
                            value="@if (!empty($data->footerAlerts)) {{ $data->footerAlerts }}@else{{ config('setting.footerAlerts') }}@endif"
                            placeholder="Footer Alerts Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="exploreNoResults"
                            value="@if (!empty($data->exploreNoResults)) {{ $data->exploreNoResults }}@else{{ config('setting.exploreNoResults') }}@endif"
                            placeholder="Footer Account Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="restaurantNotActiveMsg"
                            value="@if (!empty($data->restaurantNotActiveMsg)) {{ $data->restaurantNotActiveMsg }}@else{{ config('setting.restaurantNotActiveMsg') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="mockSearchPlaceholder"
                            value="@if (!empty($data->mockSearchPlaceholder)) {{ $data->mockSearchPlaceholder }}@else{{ config('setting.mockSearchPlaceholder') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="pwaInstallFooterMessage"
                            value="@if (!empty($data->pwaInstallFooterMessage)) {{ $data->pwaInstallFooterMessage }}@else{{ config('setting.pwaInstallFooterMessage') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="pwaInstallFooterInstallText"
                            value="@if (!empty($data->pwaInstallFooterInstallText)) {{ $data->pwaInstallFooterInstallText }}@else{{ config('setting.pwaInstallFooterInstallText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="markAllAlertReadText"
                            value="@if (!empty($data->markAllAlertReadText)) {{ $data->markAllAlertReadText }}@else{{ config('setting.markAllAlertReadText') }}@endif"
                            placeholder="Mark All Read Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="noNewAlertsText"
                            value="@if (!empty($data->noNewAlertsText)) {{ $data->noNewAlertsText }}@else{{ config('setting.noNewAlertsText') }}@endif"
                            placeholder="No New Alerts Text">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="restaurantSearchPlaceholder"
                            value="{{ $data->restaurantSearchPlaceholder }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="searchAtleastThreeCharsMsg"
                            value="{{ $data->searchAtleastThreeCharsMsg }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="exlporeByRestaurantText"
                            value="@if (!empty($data->exlporeByRestaurantText)) {{ $data->exlporeByRestaurantText }}@else{{ config('setting.exlporeByRestaurantText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="itemSearchPlaceholder"
                            value="@if (!empty($data->itemSearchPlaceholder)) {{ $data->itemSearchPlaceholder }}@else{{ config('setting.itemSearchPlaceholder') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="itemSearchText"
                            value="@if (!empty($data->itemSearchText)) {{ $data->itemSearchText }}@else{{ config('setting.itemSearchText') }}@endif"
                            placeholder="Item Search Reuslts Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="itemSearchNoResultText"
                            value="@if (!empty($data->itemSearchNoResultText)) {{ $data->itemSearchNoResultText }}@else{{ config('setting.itemSearchNoResultText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="itemsMenuButtonText"
                            value="@if (!empty($data->itemsMenuButtonText)) {{ $data->itemsMenuButtonText }}@else{{ config('setting.itemsMenuButtonText') }}@endif"
                            placeholder="Item Menu Button Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="itemPercentageDiscountText"
                            value="@if (!empty($data->itemPercentageDiscountText)) {{ $data->itemPercentageDiscountText }}@else{{ config('setting.itemPercentageDiscountText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="summernote-editor" name="customCartMessage"
                            placeholder="Custom Cart Message - Leave empty to hide" rows="6">@if (!empty($data->customCartMessage)) {{ $data->customCartMessage }}@else{{ config('setting.customCartMessage') }}@endif
                        </textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartSuggestionPlaceholder"
                            value="{{ $data->cartSuggestionPlaceholder }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="couponNotLoggedin"
                            value="@if (!empty($data->couponNotLoggedin)) {{ $data->couponNotLoggedin }}@else{{ config('setting.couponNotLoggedin') }}@endif"
                            placeholder="Coupon Not Logged In">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="applyCouponButtonText"
                            value="@if (!empty($data->applyCouponButtonText)) {{ $data->applyCouponButtonText }}@else{{ config('setting.applyCouponButtonText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="freeDeliveryPrefixText"
                            value="@if (!empty($data->freeDeliveryPrefixText)) {{ $data->freeDeliveryPrefixText }}@else {{ config('setting.freeDeliveryPrefixText') }} @endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="freeDeliverySuffixText"
                            value="@if (!empty($data->freeDeliverySuffixText)) {{ $data->freeDeliverySuffixText }}@else {{ config('setting.freeDeliverySuffixText') }} @endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartRestaurantNotOperational"
                            value="{{ $data->cartRestaurantNotOperational }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="restaurantMinOrderMessage"
                            value="@if (!empty($data->restaurantMinOrderMessage)) {{ $data->restaurantMinOrderMessage }}@else{{ config('setting.restaurantMinOrderMessage') }}@endif"
                            placeholder="Min Order Message">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartRemoveItemButton"
                            value="@if (!empty($data->cartRemoveItemButton)) {{ $data->cartRemoveItemButton }}@else{{ config('setting.cartRemoveItemButton') }}@endif"
                            placeholder="Remove Item Button">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartItemNotAvailable"
                            value="@if (!empty($data->cartItemNotAvailable)) {{ $data->cartItemNotAvailable }}@else{{ config('setting.cartItemNotAvailable') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderTextTotal"
                            value="@if (!empty($data->orderTextTotal)) {{ $data->orderTextTotal }}@else{{ config('setting.orderTextTotal') }}@endif"
                            placeholder="Order Total Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="tipText"
                            value="@if (!empty($data->tipText)) {{ $data->tipText }}@else {{ config('setting.tipText') }} @endif"
                            placeholder="Bill Detail Delivery Tip Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="tipsForDeliveryText"
                            value="@if (!empty($data->tipsForDeliveryText)) {{ $data->tipsForDeliveryText }}@else {{ config('setting.tipsForDeliveryText') }} @endif"
                            placeholder="Delivery Tip Header Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="tipsThanksText"
                            value="@if (!empty($data->tipsThanksText)) {{ $data->tipsThanksText }}@else {{ config('setting.tipsThanksText') }} @endif"
                            placeholder="Delivery Tip Thank You Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="tipsOtherText"
                            value="@if (!empty($data->tipsOtherText)) {{ $data->tipsOtherText }}@else {{ config('setting.tipsOtherText') }} @endif"
                            placeholder="Tip Other Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryTipTransactionMessage"
                            value="@if (!empty($data->deliveryTipTransactionMessage)) {{ $data->deliveryTipTransactionMessage }}@else  {{ config('setting.deliveryTipTransactionMessage') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartRemoveTipText"
                            value="@if (!empty($data->cartRemoveTipText)) {{ $data->cartRemoveTipText }}@else  {{ config('setting.cartRemoveTipText') }}@endif"
                            placeholder="Tip Remove Button Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartTipAmountPlaceholderText"
                            value="@if (!empty($data->cartTipAmountPlaceholderText)) {{ $data->cartTipAmountPlaceholderText }}@else  {{ config('setting.cartTipAmountPlaceholderText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartTipPercentagePlaceholderText"
                            value="@if (!empty($data->cartTipPercentagePlaceholderText)) {{ $data->cartTipPercentagePlaceholderText }}@else  {{ config('setting.cartTipPercentagePlaceholderText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderAmountPaidWithWallet"
                            value="@if (!empty($data->orderAmountPaidWithWallet)) {{ $data->orderAmountPaidWithWallet }}@else  {{ config('setting.orderAmountPaidWithWallet') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderAmountRemainingToPay"
                            value="@if (!empty($data->orderAmountRemainingToPay)) {{ $data->orderAmountRemainingToPay }}@else  {{ config('setting.orderAmountRemainingToPay') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg"
                            ...
                            value="@if (!empty($data->cartDeliveryTypeOptionAvailableText)) {{ $data->cartDeliveryTypeOptionAvailableText }}@else  {{ config('setting.cartDeliveryTypeOptionAvailableText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartDeliveryTypeSelectedText"
                            value="@if (!empty($data->cartDeliveryTypeSelectedText)) {{ $data->cartDeliveryTypeSelectedText }}@else  {{ config('setting.cartDeliveryTypeSelectedText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartDeliveryTypeChangeButtonText"
                            value="@if (!empty($data->cartDeliveryTypeChangeButtonText)) {{ $data->cartDeliveryTypeChangeButtonText }}@else  {{ config('setting.cartDeliveryTypeChangeButtonText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartChooseDeliveryTypeTitle"
                            value="@if (!empty($data->cartChooseDeliveryTypeTitle)) {{ $data->cartChooseDeliveryTypeTitle }}@else  {{ config('setting.cartChooseDeliveryTypeTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartReplaceItemTitle"
                            value="@if (!empty($data->cartReplaceItemTitle)) {{ $data->cartReplaceItemTitle }}@else  {{ config('setting.cartReplaceItemTitle') }}@endif"
                            placeholder="Cart Replace Item Title">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartReplaceItemSubTitle"
                            value="@if (!empty($data->cartReplaceItemSubTitle)) {{ $data->cartReplaceItemSubTitle }}@else  {{ config('setting.cartReplaceItemSubTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartReplaceItemActionNo"
                            value="@if (!empty($data->cartReplaceItemActionNo)) {{ $data->cartReplaceItemActionNo }}@else  {{ config('setting.cartReplaceItemActionNo') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cartReplaceItemActionYes"
                            value="@if (!empty($data->cartReplaceItemActionYes)) {{ $data->cartReplaceItemActionYes }}@else  {{ config('setting.cartReplaceItemActionYes') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutPaymentListTitle"
                            value="{{ $data->checkoutPaymentListTitle }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutPaymentInProcess"
                            value="{{ $data->checkoutPaymentInProcess }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutPaytmText"
                            value="@if(!empty($data->checkoutPaytmText)){{ $data->checkoutPaytmText }}@else{{ config('setting.checkoutPaytmText') }}@endif"
                            placeholder="Paytm Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutPaytmSubText"
                            value="@if(!empty($data->checkoutPaytmSubText)){{ $data->checkoutPaytmSubText }}@else{{ config('setting.checkoutPaytmSubText') }}@endif"
                            placeholder="Paytm Sub Text">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="summernote-editor" name="userInActiveMessage" placeholder="User Banned Message"
                            rows="6">@if(!empty($data->userInActiveMessage)){{ $data->userInActiveMessage }}@else{{ config('setting.userInActiveMessage') }}@endif</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="tooManyApiCallMessage"
                            value="@if(!empty($data->tooManyApiCallMessage)){{ $data->tooManyApiCallMessage }}@else{{ config('setting.tooManyApiCallMessage') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutStripeIdealText"
                            value="@if(!empty($data->checkoutStripeIdealText)){{ $data->checkoutStripeIdealText }}@else{{ config('setting.checkoutStripeIdealText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutStripeIdealSubText"
                            value="@if(!empty($data->checkoutStripeIdealSubText)){{ $data->checkoutStripeIdealSubText }}@else{{ config('setting.checkoutStripeIdealSubText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutStripeFpxText"
                            value="@if(!empty($data->checkoutStripeFpxText)){{ $data->checkoutStripeFpxText }}@else{{ config('setting.checkoutStripeFpxText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutStripeFpxSubText"
                            value="@if(!empty($data->checkoutStripeFpxSubText)){{ $data->checkoutStripeFpxSubText }}@else{{ config('setting.checkoutStripeFpxSubText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutMercadoPagoText"
                            value="@if(!empty($data->checkoutMercadoPagoText)){{ $data->checkoutMercadoPagoText }}@else{{ config('setting.checkoutMercadoPagoText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutMercadoPagoSubText"
                            value="@if(!empty($data->checkoutMercadoPagoSubText)){{ $data->checkoutMercadoPagoSubText }}@else{{ config('setting.checkoutMercadoPagoSubText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutPayMongoText"
                            value="@if(!empty($data->checkoutPayMongoText)){{ $data->checkoutPayMongoText }}@else{{ config('setting.checkoutPayMongoText') }}@endif"
                            placeholder="PayMongo Checkout Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutPayMongoSubText"
                            value="@if(!empty($data->checkoutPayMongoSubText)){{ $data->checkoutPayMongoSubText }}@else{{ config('setting.checkoutPayMongoSubText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutPayText"
                            value="@if(!empty($data->checkoutPayText)){{ $data->checkoutPayText }}@else{{ config('setting.checkoutPayText') }}@endif"
                            placeholder="Checkout Pay Button Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutCardNumber"
                            value="@if(!empty($data->checkoutCardNumber)){{ $data->checkoutCardNumber }}@else{{ config('setting.checkoutCardNumber') }}@endif"
                            placeholder="Checkout Card Number Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutCardExpiration"
                            value="@if(!empty($data->checkoutCardExpiration)){{ $data->checkoutCardExpiration }}@else{{ config('setting.checkoutCardExpiration') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutCardCvv"
                            value="@if(!empty($data->checkoutCardCvv)){{ $data->checkoutCardCvv }}@else{{ config('setting.checkoutCardCvv') }}@endif"
                            placeholder="Checkout CVV Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutCardPostalCode"
                            value="@if(!empty($data->checkoutCardPostalCode)){{ $data->checkoutCardPostalCode }}@else{{ config('setting.checkoutCardPostalCode') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutCardFullname"
                            value="@if(!empty($data->checkoutCardFullname)){{ $data->checkoutCardFullname }}@else{{ config('setting.checkoutCardFullname') }}@endif"
                            placeholder="Checkout Full Name Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutIdealSelectBankText"
                            value="@if(!empty($data->checkoutIdealSelectBankText)){{ $data->checkoutIdealSelectBankText }}@else{{ config('setting.checkoutIdealSelectBankText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutFpxSelectBankText"
                            value="@if(!empty($data->checkoutFpxSelectBankText)){{ $data->checkoutFpxSelectBankText }}@else{{ config('setting.checkoutFpxSelectBankText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutFlutterwaveText"
                            value="@if(!empty($data->checkoutFlutterwaveText)){{ $data->checkoutFlutterwaveText }}@else{{ config('setting.checkoutFlutterwaveText') }}@endif"
                            placeholder="Flutterwave Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutFlutterwaveSubText"
                            value="@if(!empty($data->checkoutFlutterwaveSubText)){{ $data->checkoutFlutterwaveSubText }}@else{{ config('setting.checkoutFlutterwaveSubText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutKhaltiText"
                            value="@if(!empty($data->checkoutKhaltiText)){{ $data->checkoutKhaltiText }}@else{{ config('setting.checkoutKhaltiText') }}@endif"
                            placeholder="Khalti Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutKhaltiSubText"
                            value="@if(!empty($data->checkoutKhaltiSubText)){{ $data->checkoutKhaltiSubText }}@else{{ config('setting.checkoutKhaltiSubText') }}@endif"
                            placeholder="Khalti Sub Text">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cashChangeTitle"
                            value="@if(!empty($data->cashChangeTitle)){{ $data->cashChangeTitle }}@else{{ config('setting.cashChangeTitle') }}@endif"
                            placeholder="Cash Change Title">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cashChangeInputPlaceholder"
                            value="@if(!empty($data->cashChangeInputPlaceholder)){{ $data->cashChangeInputPlaceholder }}@else{{ config('setting.cashChangeInputPlaceholder') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cashChangeConfirmButton"
                            value="@if(!empty($data->cashChangeConfirmButton)){{ $data->cashChangeConfirmButton }}@else{{ config('setting.cashChangeConfirmButton') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cashChangeHelpText"
                            value="@if(!empty($data->cashChangeHelpText)){{ $data->cashChangeHelpText }}@else{{ config('setting.cashChangeHelpText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea class="summernote-editor" name="checkoutMessageOnIdle"
                            ...
                            rows="6">@if (!empty($data->checkoutMessageOnIdle)) {{ $data->checkoutMessageOnIdle }}@else{{ config('setting.checkoutMessageOnIdle') }}@endif</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="checkoutMessageOnProcess"
                            value="@if(!empty($data->checkoutMessageOnProcess)){{ $data->checkoutMessageOnProcess }}@else{{ config('setting.checkoutMessageOnProcess') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="runningOrderDeliveryAssignedSub"
                            value="{{ $data->runningOrderDeliveryAssignedSub }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="runningOrderReadyForPickupSub"
                            value="{{ $data->runningOrderReadyForPickupSub }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="awaitingPaymentStatusText"
                            value="@if(!empty($data->awaitingPaymentStatusText)){{ $data->awaitingPaymentStatusText }}@else{{ config('setting.awaitingPaymentStatusText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="paymentFailedStatusText"
                            value="@if(!empty($data->paymentFailedStatusText)){{ $data->paymentFailedStatusText }}@else{{ config('setting.paymentFailedStatusText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="runningOrderDelivered"
                            value="@if(!empty($data->runningOrderDelivered)){{ $data->runningOrderDelivered }}@else{{ config('setting.runningOrderDelivered') }}@endif"
                            placeholder="Order Delivered Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="runningOrderDeliveredSub"
                            value="@if(!empty($data->runningOrderDeliveredSub)){{ $data->runningOrderDeliveredSub }}@else{{ config('setting.runningOrderDeliveredSub') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryGuyAssignedStatusText"
                            value="{{ $data->deliveryGuyAssignedStatusText }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg"
                            ...
                            value="{{ $data->deliveryGuyNewOrderNotificationMsg }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg"
                            ...
                            value="{{ $data->deliveryGuyNewOrderNotificationMsgSub }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="awaitingPaymentTitle"
                            value="@if (!empty($data->awaitingPaymentTitle)) {{ $data->awaitingPaymentTitle }}@else{{ config('setting.awaitingPaymentTitle') }}@endif"
                            placeholder="waiting Payment Title">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="awaitingPaymentSubTitle"
                            value="@if (!empty($data->awaitingPaymentSubTitle)) {{ $data->awaitingPaymentSubTitle }}@else{{ config('setting.awaitingPaymentSubTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderDetailsPaymentMode"
                            value="@if (!empty($data->orderDetailsPaymentMode)) {{ $data->orderDetailsPaymentMode }}@else{{ config('setting.orderDetailsPaymentMode') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="awaitingPaymentTimerText"
                            value="@if (!empty($data->awaitingPaymentTimerText)) {{ $data->awaitingPaymentTimerText }}@else{{ config('setting.awaitingPaymentTimerText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="chooseAvatarText"
                            value="@if (!empty($data->chooseAvatarText)) {{ $data->chooseAvatarText }}@else{{ config('setting.chooseAvatarText') }}@endif"
                            placeholder="Choose Avatar Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="accountMyFavouriteStores"
                            value="@if (!empty($data->accountMyFavouriteStores)) {{ $data->accountMyFavouriteStores }}@else{{ config('setting.accountMyFavouriteStores') }}@endif"
                            placeholder="My Favourite Stores">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="favouriteStoresPageTitle"
                            value="@if (!empty($data->favouriteStoresPageTitle)) {{ $data->favouriteStoresPageTitle }}@else{{ config('setting.favouriteStoresPageTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="accountTaxVatText"
                            value="@if (!empty($data->accountTaxVatText)) {{ $data->accountTaxVatText }}@else{{ config('setting.accountTaxVatText') }}@endif"
                            placeholder="Tax/Vat Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="customerVatSave"
                            value="@if (!empty($data->customerVatSave)) {{ $data->customerVatSave }}@else{{ config('setting.customerVatSave') }}@endif"
                            placeholder="Tax/Vat Save Button Text">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="useGpsMessage"
                            value="@if (!empty($data->useGpsMessage)) {{ $data->useGpsMessage }}@else{{ config('setting.useGpsMessage') }}@endif"
                            placeholder="Use Gps Message Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="useGpsButtonText"
                            value="@if (!empty($data->useGpsButtonText)) {{ $data->useGpsButtonText }}@else{{ config('setting.useGpsButtonText') }}@endif"
                            placeholder="Use Gps Button Text">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="locationSavedAddresses"
                            value="@if (!empty($data->locationSavedAddresses)) {{ $data->locationSavedAddresses }}@else{{ config('setting.locationSavedAddresses') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="noAddressText"
                            value="@if (!empty($data->noAddressText)) {{ $data->noAddressText }}@else{{ config('setting.noAddressText') }}@endif"
                            placeholder="No Address Text">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderPaymentWalletComment"
                            value="{{ $data->orderPaymentWalletComment }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderPartialPaymentWalletComment"
                            value="{{ $data->orderPartialPaymentWalletComment }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderRefundWalletComment"
                            value="{{ $data->orderRefundWalletComment }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderPartialRefundWalletComment"
                            value="{{ $data->orderPartialRefundWalletComment }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="cancelOrderMainButton"
                            value="{{ $data->cancelOrderMainButton }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="willNotBeRefundedText"
                            value="{{ $data->willNotBeRefundedText }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderCancellationConfirmationText"
                            value="{{ $data->orderCancellationConfirmationText }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryPickedupOrdersTitle"
                            value="@if (!empty($data->deliveryPickedupOrdersTitle)) {{ $data->deliveryPickedupOrdersTitle }}@else{{ config('setting.deliveryPickedupOrdersTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryNoPickedupOrdersMsg"
                            value="@if (!empty($data->deliveryNoPickedupOrdersMsg)) {{ $data->deliveryNoPickedupOrdersMsg }}@else{{ config('setting.deliveryNoPickedupOrdersMsg') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAlreadyAccepted"
                            value="{{ $data->deliveryAlreadyAccepted }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryLogoutConfirmation"
                            value="{{ $data->deliveryLogoutConfirmation }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryFooterNewTitle"
                            value="@if (!empty($data->deliveryFooterNewTitle)) {{ $data->deliveryFooterNewTitle }}@else{{ config('setting.deliveryFooterNewTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryFooterAcceptedTitle"
                            value="@if (!empty($data->deliveryFooterAcceptedTitle)) {{ $data->deliveryFooterAcceptedTitle }}@else{{ config('setting.deliveryFooterAcceptedTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryFooterPickedup"
                            value="@if (!empty($data->deliveryFooterPickedup)) {{ $data->deliveryFooterPickedup }}@else{{ config('setting.deliveryFooterPickedup') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryFooterAccount"
                            value="@if (!empty($data->deliveryFooterAccount)) {{ $data->deliveryFooterAccount }}@else{{ config('setting.deliveryFooterAccount') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryEarningsText"
                            value="@if (!empty($data->deliveryEarningsText)) {{ $data->deliveryEarningsText }}@else{{ config('setting.deliveryEarningsText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryCollectionText"
                            value="@if (!empty($data->deliveryCollectionText)) {{ $data->deliveryCollectionText }}@else{{ config('setting.deliveryCollectionText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryOnGoingText"
                            value="@if (!empty($data->deliveryOnGoingText)) {{ $data->deliveryOnGoingText }}@else{{ config('setting.deliveryOnGoingText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryCompletedText"
                            value="@if (!empty($data->deliveryCompletedText)) {{ $data->deliveryCompletedText }}@else{{ config('setting.deliveryCompletedText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryCommissionMessage"
                            value="@if (!empty($data->deliveryCommissionMessage)) {{ $data->deliveryCommissionMessage }}@else{{ config('setting.deliveryCommissionMessage') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="updatingMessage"
                            value="@if (!empty($data->updatingMessage)) {{ $data->updatingMessage }}@else{{ config('setting.updatingMessage') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="categoriesFiltersText"
                            value="@if (!empty($data->categoriesFiltersText)) {{ $data->categoriesFiltersText }}@else{{ config('setting.categoriesFiltersText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="categoriesNoRestaurantsFoundText"
                            value="@if (!empty($data->categoriesNoRestaurantsFoundText)) {{ $data->categoriesNoRestaurantsFoundText }}@else{{ config('setting.categoriesNoRestaurantsFoundText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryTotalEarningsText"
                            value="@if (!empty($data->deliveryTotalEarningsText)) {{ $data->deliveryTotalEarningsText }}@else{{ config('setting.deliveryTotalEarningsText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryUsePhoneToAccessMsg"
                            value="@if (!empty($data->deliveryUsePhoneToAccessMsg)) {{ $data->deliveryUsePhoneToAccessMsg }}@else{{ config('setting.deliveryUsePhoneToAccessMsg') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryMaxOrderReachedMsg"
                            value="@if (!empty($data->deliveryMaxOrderReachedMsg)) {{ $data->deliveryMaxOrderReachedMsg }}@else{{ config('setting.deliveryMaxOrderReachedMsg') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryEarningCommissionText"
                            value="@if (!empty($data->deliveryEarningCommissionText)) {{ $data->deliveryEarningCommissionText }}@else{{ config('setting.deliveryEarningCommissionText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryEarningTipText"
                            value="@if (!empty($data->deliveryEarningTipText)) {{ $data->deliveryEarningTipText }}@else{{ config('setting.deliveryEarningTipText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryEarningTotalEarningText"
                            value="@if (!empty($data->deliveryEarningTotalEarningText)) {{ $data->deliveryEarningTotalEarningText }}@else{{ config('setting.deliveryEarningTotalEarningText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryLastSevenDaysEarningTitle"
                            value="@if (!empty($data->deliveryLastSevenDaysEarningTitle)) {{ $data->deliveryLastSevenDaysEarningTitle }}@else{{ config('setting.deliveryLastSevenDaysEarningTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryToggleLightDarkMode"
                            value="@if (!empty($data->deliveryToggleLightDarkMode)) {{ $data->deliveryToggleLightDarkMode }}@else{{ config('setting.deliveryToggleLightDarkMode') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAppRequestedCashChangeMsg"
                            value="@if (!empty($data->deliveryAppRequestedCashChangeMsg)) {{ $data->deliveryAppRequestedCashChangeMsg }}@else{{ config('setting.deliveryAppRequestedCashChangeMsg') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAppYouAreOnlineBtn"
                            value="@if (!empty($data->deliveryAppYouAreOnlineBtn)) {{ $data->deliveryAppYouAreOnlineBtn }}@else{{ config('setting.deliveryAppYouAreOnlineBtn') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="deliveryAppYouAreOfflineBtn"
                            value="@if (!empty($data->deliveryAppYouAreOfflineBtn)) {{ $data->deliveryAppYouAreOfflineBtn }}@else{{ config('setting.deliveryAppYouAreOfflineBtn') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="inAppCloseButton"
                            value="@if (!empty($data->inAppCloseButton)) {{ $data->inAppCloseButton }}@else{{ config('setting.inAppCloseButton') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="inAppOpenLinkButton"
                            value="@if (!empty($data->inAppOpenLinkButton)) {{ $data->inAppOpenLinkButton }}@else{{ config('setting.inAppOpenLinkButton') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="iOSPWAPopupTitle"
                            value="@if (!empty($data->iOSPWAPopupTitle)) {{ $data->iOSPWAPopupTitle }}@else{{ config('setting.iOSPWAPopupTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="iOSPWAPopupBody"
                            value="@if (!empty($data->iOSPWAPopupBody)) {{ $data->iOSPWAPopupBody }}@else{{ config('setting.iOSPWAPopupBody') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="iOSPWAPopupShareButtonLabel"
                            value="@if (!empty($data->iOSPWAPopupShareButtonLabel)) {{ $data->iOSPWAPopupShareButtonLabel }}@else{{ config('setting.iOSPWAPopupShareButtonLabel') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="iOSPWAPopupAddButtonLabel"
                            value="@if (!empty($data->iOSPWAPopupAddButtonLabel)) {{ $data->iOSPWAPopupAddButtonLabel }}@else{{ config('setting.iOSPWAPopupAddButtonLabel') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="iOSPWAPopupCloseButtonLabel"
                            value="@if (!empty($data->iOSPWAPopupCloseButtonLabel)) {{ $data->iOSPWAPopupCloseButtonLabel }}@else{{ config('setting.iOSPWAPopupCloseButtonLabel') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="offlineTitleMessage"
                            value="@if (!empty($data->offlineTitleMessage)) {{ $data->offlineTitleMessage }}@else{{ config('setting.offlineTitleMessage') }}@endif"
                            placeholder="Offline Title Message">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="offlineSubTitleMessage"
                            value="@if (!empty($data->offlineSubTitleMessage)) {{ $data->offlineSubTitleMessage }}@else{{ config('setting.offlineSubTitleMessage') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="orderRateOrderButton"
                            value="@if (!empty($data->orderRateOrderButton)) {{ $data->orderRateOrderButton }}@else{{ config('setting.orderRateOrderButton') }}@endif"
                            placeholder="Rate Order Button Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="reviewsPageTitle"
                            value="@if (!empty($data->reviewsPageTitle)) {{ $data->reviewsPageTitle }}@else{{ config('setting.reviewsPageTitle') }}@endif"
                            placeholder="Ratings Page Title">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="rarModRatingPageTitle"
                            value="@if (!empty($data->rarModRatingPageTitle)) {{ $data->rarModRatingPageTitle }}@else{{ config('setting.rarModRatingPageTitle') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="rarModDeliveryRatingTitle"
                            value="@if (!empty($data->rarModDeliveryRatingTitle)) {{ $data->rarModDeliveryRatingTitle }}@else{{ config('setting.rarModDeliveryRatingTitle') }}@endif"
                            placeholder="Rate Delivery Title">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="rarReviewBoxTitleDeliveryFeedback"
                            value="@if (!empty($data->rarReviewBoxTitleDeliveryFeedback)) {{ $data->rarReviewBoxTitleDeliveryFeedback }}@else{{ config('setting.rarReviewBoxTitleDeliveryFeedback') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="rarModRestaurantRatingTitle"
                            value="@if (!empty($data->rarModRestaurantRatingTitle)) {{ $data->rarModRestaurantRatingTitle }}@else{{ config('setting.rarModRestaurantRatingTitle') }}@endif"
                            placeholder="Rate Store Title">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="rarReviewBoxTitleStoreFeedback"
                            value="@if (!empty($data->rarReviewBoxTitleStoreFeedback)) {{ $data->rarReviewBoxTitleStoreFeedback }}@else{{ config('setting.rarReviewBoxTitleStoreFeedback') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="rarReviewBoxTextPlaceHolderText"
                            value="@if (!empty($data->rarReviewBoxTextPlaceHolderText)) {{ $data->rarReviewBoxTextPlaceHolderText }}@else{{ config('setting.rarReviewBoxTextPlaceHolderText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="ratingsRequiredMessage"
                            value="@if (!empty($data->ratingsRequiredMessage)) {{ $data->ratingsRequiredMessage }}@else{{ config('setting.ratingsRequiredMessage') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="rarSubmitButtonText"
                            value="@if (!empty($data->rarSubmitButtonText)) {{ $data->rarSubmitButtonText }}@else{{ config('setting.rarSubmitButtonText') }}@endif"
                ...
                <button class="btn btn-primary translation-section-btn mt-4" type="button"> <i
                        class="icon-calendar2 mr-1"></i>Order Schedule</button>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="modOSScheduleThisOrderText"
                            value="@if (!empty($data->modOSScheduleThisOrderText)) {{ $data->modOSScheduleThisOrderText }}@else{{ config('setting.modOSScheduleThisOrderText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="modOSScheduleForText"
                            value="@if (!empty($data->modOSScheduleForText)) {{ $data->modOSScheduleForText }}@else{{ config('setting.modOSScheduleForText') }}@endif"
                            placeholder="Schedule for Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="modOSSelectDateTimeText"
                            value="@if (!empty($data->modOSSelectDateTimeText)) {{ $data->modOSSelectDateTimeText }}@else{{ config('setting.modOSSelectDateTimeText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="modOSDoneBtnText"
                            value="@if (!empty($data->modOSDoneBtnText)) {{ $data->modOSDoneBtnText }}@else{{ config('setting.modOSDoneBtnText') }}@endif"
                            placeholder="Done Button Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="modOSRemoveBtnText"
                            value="@if (!empty($data->modOSRemoveBtnText)) {{ $data->modOSRemoveBtnText }}@else{{ config('setting.modOSRemoveBtnText') }}@endif"
                            placeholder="Remove Button Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="modOSSlotNotAvalText"
                            value="@if (!empty($data->modOSSlotNotAvalText)) {{ $data->modOSSlotNotAvalText }}@else{{ config('setting.modOSSlotNotAvalText') }}@endif"
                            placeholder="No Slots Available Text">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="scheduledOrderStatusText"
                            value="@if (!empty($data->scheduledOrderStatusText)) {{ $data->scheduledOrderStatusText }}@else{{ config('setting.scheduledOrderStatusText') }}@endif"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control form-control-lg" name="confirmedOrderStatusText"
                            value="@if (!empty($data->confirmedOrderStatusText)) {{ $data->confirmedOrderStatusText }}@else{{ config('setting.confirmedOrderStatusText') }}@endif"
                ...
                <div class="text-left">
                    <button type="button" class="btn btn-danger" data-toggle="modal"
                        data-target="#deleteTranslationConfirmModal">
                        Delete Translation
    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span class="help-text">Attention!!! This change is permanent. <br> You can use the
                    "<strong>DISABLE</strong>" feature to temporarily disable the translation.</span>
                <div class="modal-footer mt-4">
                    <a href="{{ route('admin.deleteTranslation', $translation_id) }}" class="btn btn-primary">Yes
                        Delete</a>
