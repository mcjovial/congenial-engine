                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    @if($location->is_active)
                                    <a href="{{ route('admin.disableLocation', $location->id) }}"
                                    ...
                                    <a href="{{ route('admin.disableLocation', $location->id) }}"
                                        ...
                                        title="Enable Location" data-placement="bottom"> <i class="icon-switch2"></i>
                                    </a>
                                    @endif
                                </div>
                            </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.saveNewLocation') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Short
                            Description:</label>
                        <div class="col-lg-9">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.locationBulkUpload') }}" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <div class="uploader">
                                <input type="file" accept=".csv" name="location_csv"
